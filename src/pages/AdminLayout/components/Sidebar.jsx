  ...
  return (
    <div className="w-[250px] overflow-y-auto h-dvh bg-gradient-to-r from-green-bonek-1 to-green-bonek-2 px-4">
        ...
        <ul className="w-full grid gap-2">
            ...
            <>
              <li>
                <NavLink
                  ...
                  className="inline-block hover:bg-white hover:text-green-bonek-1 rounded w-full px-3 py-2 text-white font-semibold"
                >
                  Dashboard
                </NavLink>
              </li>
          ...
          {user.role === "user" ? (
            <>
              <li>
                <NavLink
                  to={Router.admin.orders["list-orders"]}
                  className="inline-block hover:bg-white hover:text-green-bonek-1 rounded w-full px-3 py-2 text-white font-semibold"
                >
                  Orders
                </NavLink>
              ...
              <li>
                <NavLink
                  to={Router.admin["create-merchant"]}
                  className="inline-block hover:bg-white hover:text-green-bonek-1 rounded w-full px-3 py-2 text-white font-semibold"
                >
                  Create Merchant
                </NavLink>
      ...
      <div className="py-8 flex items-center">
        <NavLink
          to={Router.home}
          className="bg-slate-400 hover:bg-black text-white font-bold py-2 px-4 rounded-2xl mr-3"
        >
          Kembali
        </NavLink>
        <button
