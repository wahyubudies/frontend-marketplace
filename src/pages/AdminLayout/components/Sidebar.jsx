                ...
                <ul className='w-full grid gap-2'>
                    ...
                    {user.role === "user" ? (
                        <>
                            ...
                            <li>
                                <NavLink to={Router.admin['create-merchant']} className="inline-block hover:bg-white hover:text-green-bonek-1 rounded w-full px-3 py-2 text-white font-semibold">
                                    Create Merchant
                                </NavLink>
                            </li>
                        </>
